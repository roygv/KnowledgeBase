A `git rebase` _copies_ the commits from the current branch, and puts these copied commits on top of the specified branch. You may, for example, rebase a branch to master or vice versa.
